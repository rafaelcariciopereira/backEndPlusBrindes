...
from .views_product import ProdutoListCreateView, ProdutoRetrieveUpdateDestroyView
...
# Rotas:
# 1. '/produtos/' - Métodos: GET (lista todos os produtos) e POST (cria um novo produto).
